...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sUzWCDQhFF" once="menu" id="menu1-m">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>Pharmaceuticals</strong></h4>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <a href="#"><img src="assets/images/mbr-3-816x544.jpg" alt="Mobirise"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md">
                                    <h6 class="card-title mbr-fonts-style display-5"><strong>Sample Pharmaceutical</strong></h6>
        ...
        <div class="card">
            <div class="card-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <a href="#"><img src="assets/images/mbr-1-816x540.jpg" alt="Mobirise"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md">
                                    <h6 class="card-title mbr-fonts-style display-5"><strong>Sample Pharmaceutical 2</strong></h6>
                                    <p class="mbr-text mbr-fonts-style display-7">Description</p>
                                </div>
                                <div class="col-md-auto">
                                    <p class="price mbr-fonts-style display-2">$29</p>
...
<section data-bs-version="5.1" class="footer6 cid-sUzWCEqZxb mbr-parallax-background" once="footers" id="footer6-n">
