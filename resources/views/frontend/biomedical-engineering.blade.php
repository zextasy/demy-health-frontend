...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sVlBvzl8s4" once="menu" id="menu1-2j">
...
<section data-bs-version="5.1" class="info3 cid-sVlBvyTmEM" id="info3-2i">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>Biomedical Engineering</strong></h4>
...
<section data-bs-version="5.1" class="image2 cid-sVlPQnlRUR mbr-parallax-background" id="image2-2l">
...
<section data-bs-version="5.1" class="clients1 cid-sVlQARVMRi" id="clients1-2m">
...
<section data-bs-version="5.1" class="footer6 cid-sVlBvAeh4F mbr-parallax-background" once="footers" id="footer6-2k">
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/u" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;">Make your own site with <a href="https://mobirise.site/z" style="color:#aaa;">Mobirise</a></p></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/parallax/jarallax.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>
