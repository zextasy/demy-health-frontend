...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sUzUTyRZRf" once="menu" id="menu1-16">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>About DemyHealth Clinic and Genomic Medicine</strong></h4>
                ...
                <div class="card-wrapper">
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            DemyHealth is a leading healthcare service provider in Nigeria, with core specialization in molecular diagnostics. Our subsidiaries, Genomic Technologies and Next Gen Biotech, offer extensive biotechnology equipment and services covering a broad range of activities in life sciences.<br><br>Using molecular techniques, DemyHealth has since 2016 provided medical practitioners from many different specialties valuable diagnostic information to assist in the detection, diagnosis, evaluation, and treatment of bacterial, viral and fungal infections as well as genetic based testing and cancer diagnostics. Our stable specimen collection and transport platforms enable the conduct of a variety of PCR based tests from a single swab or blood sample with high sensitivity and specificity. We also offer third party clinical testing and life science research services to individuals, private corporations and government organizations.<br><br><strong>Our expertise has led to partnerships with leading foreign healthcare brands and ISO certified laboratories within and outside the country.</strong><br></p>
...
<section data-bs-version="5.1" class="content8 cid-sVgyPMXQ56" id="content8-1c">

    <div class="container">
        <div class="row justify-content-center">
            <div class="counter-container col-md-12 col-lg-10">
                <h4 class="mbr-section-title mbr-fonts-style mb-4 display-5">We Have</h4>
...
<section data-bs-version="5.1" class="footer6 cid-sUzUTAZ4di mbr-parallax-background" once="footers" id="footer6-17">
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/j" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/q" style="color:#aaa;">This site</a> was started with Mobirise web themes</p></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/parallax/jarallax.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>
