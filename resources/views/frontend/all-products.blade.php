    ...
    <section data-bs-version="5.1" class="features8 cid-sUzTgfTEN7" xmlns="http://www.w3.org/1999/html" id="features9-d">
        ...
        <div class="container">
            @foreach($products as $product)
                @include('components.mobirise.single-product-display',['imageUrl'=>'assets/images/mbr-816x540.jpg', 'title' => $product->name, 'description' =>$product->description, 'price' => $product->price ,'buttonUrl'=>'#','buttonText' =>'Buy Now'])
            @endforeach
