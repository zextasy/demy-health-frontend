...
<head>
  ...
  <title>Hospital and Laboratory products</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sUzUTyRZRf" once="menu" id="menu1-i">
...
<section data-bs-version="5.1" class="info3 cid-sUzUTw6vBK" id="info3-g">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>Hospital and Laboratory products</strong></h4>
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            See a list of our products below.</p>
...
<section data-bs-version="5.1" class="features8 cid-sUzUTwYqUa" xmlns="http://www.w3.org/1999/html" id="features9-h">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <a href="#"><img src="assets/images/mbr-1-816x544.jpg" alt="Mobirise"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md">
                                    <h6 class="card-title mbr-fonts-style display-5"><strong>Sample&nbsp; Hospital Equipment</strong></h6>
        ...
        <div class="card">
            <div class="card-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <a href="#"><img src="assets/images/mbr-2-816x544.jpg" alt="Mobirise"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md">
                                    <h6 class="card-title mbr-fonts-style display-5"><strong>Sample Lab Equpment</strong></h6>
                                    <p class="mbr-text mbr-fonts-style display-7">Description</p>
                                </div>
                                <div class="col-md-auto">
                                    <p class="price mbr-fonts-style display-2">$29</p>
...
<section data-bs-version="5.1" class="footer6 cid-sUzUTAZ4di mbr-parallax-background" once="footers" id="footer6-j">
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/b" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/i" style="color:#aaa;">Made with Mobirise</a> website software</p></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/parallax/jarallax.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>
