...
<head>
  ...
  <title>PCR testing, diagnostics and research</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sVgU3m9rXe" once="menu" id="menu1-25">
...
<section data-bs-version="5.1" class="info3 cid-sVgU3lqRee" id="info3-23">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>PCR testing, diagnostics and research</strong></h4>
...
<section data-bs-version="5.1" class="content8 cid-sVlR9Ufp0h" id="content8-2n">
            ...
            <div class="counter-container col-md-12 col-lg-10">
                ...
                <div class="mbr-text mbr-fonts-style display-7">
                    <ul>
                        ...
                        <li>Set up over 40 fully functional biosafety level 2 and level 3 molecular laboratories in Nigeria.</li><li>Sold and installed 50 PCR machines, 30 automated nucleic acid extractors and many other biotechnology solutions in Nigeria since 2018. 1We have also sold several millions of molecular diagnostic test kits, research test kits and consumables.</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section data-bs-version="5.1" class="footer6 cid-sVgU3mxw9u mbr-parallax-background" once="footers" id="footer6-26">
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/j" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;">Mobirise page creator - <a href="https://mobirise.site/o" style="color:#aaa;">Go now</a></p></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/parallax/jarallax.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>
